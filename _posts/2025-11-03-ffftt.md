...
- Battle:
  ...
  - Every unit in turn uses all possible abilities.
    - Abilities will have prerequisites, like range, and so sometimes will be unable to trigger
...
For the sake of simplicity, I'm using the *FFT* job system here. This is a thought experiment not a prescription.
